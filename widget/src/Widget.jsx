  ...
  return (
    <div className="p-6 md:p-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <button onClick={() => setIsFormOpen(!isFormOpen)} className="px-5 py-2.5 rounded-full font-bold text-sm transition-opacity hover:opacity-90" style={{ backgroundColor: 'var(--echo-primary)', color: 'var(--echo-bg)' }}>
      ...
      <div className="flex gap-4 overflow-x-auto no-scrollbar pb-6 snap-x pt-2">
        {reviews.length === 0 ? <p className="opacity-50 italic">No reviews yet.</p> : reviews.map(r => (
